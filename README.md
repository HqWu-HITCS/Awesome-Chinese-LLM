...
常见底座模型细节概览：
| 底座名称     | 模型参数大小          | 训练token数  | 训练数据/模型参数 | 训练最大长度 | 是否可商用 |
|----------|-----------------|-----------|--------|-------|-------|
| ChatGLM  | 6B              | 1T        | 167 | 2K     | 可商用   |
| ChatGLM2 | 6B              | 1.4T      | 233 | 32K    | 可商用   |
| LLaMA    | 7B/13B/33B/65B  | 1T        | 143/77/30/15 | 2k     | 不可商用  |
| LLaMA2   | 7B/13B/33B/65B  | 2T        | 286/154/61/31 | 4k     | 可商用   |
| BLOOM    | 1B7/7B1/176B-MT | 1.5T      | 882/211/8.5 | 2k     | 可商用   |
| Baichuan | 7B/13B          | 1.2T/1.4T | 171/108 | 4k     | 可商用   |
| Falcon   | 7B/40B          | 1.5T      | 214/37.5 | 2k     | 可商用   |
| Qwen     | 7B/14B/72B Base&Chat      | 2.2T/3T      | 314/157/31 & 429/214/41.7 | 8k/32k     | 可商用   |
| Aquila   | 7B/Chat-7B      | -         | - | 2k     | 可商用   |
| InternLM | 7B/20B Base&Chat | - | - | 200k | 可商用 |
| Mixtral | 8x7B Base&Chat | - | - | 32k | 可商用 |

备注：1T/1B=1\*1000\*1000\*1000\*1000/1\*1000\*1000\*1000=1000
