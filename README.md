...
* FoJin 佛津
  ...
  * 地址：[https://github.com/xr843/fojin](https://github.com/xr843/fojin)
    ![](https://img.shields.io/github/stars/xr843/fojin.svg)
  * 简介：开源佛教古籍 RAG 问答平台，基于 Dify + 通义千问，覆盖 38 部核心佛经（约 1100 万字），向量检索 + 关键词检索双知识库，回答附经文原文引用。
